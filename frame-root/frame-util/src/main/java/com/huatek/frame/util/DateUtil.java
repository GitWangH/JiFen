...
public class DateUtil {
	public static HuatekSimpleDateFormat timeFormat = new HuatekSimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	public static HuatekSimpleDateFormat timeFormat1 = new HuatekSimpleDateFormat("yyyy年MM月dd日 HH:mm:ss");
	public static HuatekSimpleDateFormat dateFormat = new HuatekSimpleDateFormat("yyyy-MM-dd");
	public static HuatekSimpleDateFormat dateFormat2 = new HuatekSimpleDateFormat("yyyyMMdd");
	public static HuatekSimpleDateFormat dateFormat3 = new HuatekSimpleDateFormat("yyyy.MM.dd");
	public static HuatekSimpleDateFormat monthAndDayFormat = new HuatekSimpleDateFormat("MM/dd");
	public static HuatekSimpleDateFormat yearAndMonthFormat = new HuatekSimpleDateFormat("yyyy-MM");
	public static HuatekSimpleDateFormat yearFormat = new HuatekSimpleDateFormat("yyyy");
	...
	public static void main(String[] args) {
		...
		List<Date> l = DateUtil.getNextMonths(null, -5);
		for (Date d : l) {
			System.out.println(d.toString() + "-" + d.getYear() + "-" + d.getMonth() + "-" + d.getDay());
		}

		l = DateUtil.getNextMonths(null, 5);
		for (Date d : l) {
			System.out.println(d.toString() + "-" + d.getYear() + "-" + d.getMonth() + "-" + d.getDay());
		}
	}
