...
public class PropertyUtil {
	...
	/**
	 * 
	* @Title: getConfigValueByPath 
	* @Description: 通过key 和配置文件路径获取配置信息
	* @createDate: 2016年11月30日 下午5:01:04
	* @param   
	* @return  String    
	* @throws
	 */
    public static String getConfigValueByPath(String key,String path) {
        ...
        try {
            path = PropertyUtil.class.getResource(path).toURI().getPath();
        } catch (URISyntaxException e) {
            e.printStackTrace();
        }
        return FileUtil.readValue(path, key);
