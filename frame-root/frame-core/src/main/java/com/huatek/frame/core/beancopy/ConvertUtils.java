 ...
 * @author Ralph Schaer
 * @author Chris Audley
 * @version $Revision: 556229 $ $Date: 2007-07-14 07:11:19 +0100 (Sat, 14 Jul
 *          2007) $
...
public class ConvertUtils {
	...
	public static Object convert(Object value, Class targetType,String patten) {

		return ConvertUtilsBean.getInstance().convert(value, targetType,patten);
	...
	public static void addConvertParam(ConvertParam key, Object value) {

		ConvertUtilsBean.getInstance().addConvertParam(key, value);
