...
import com.huatek.frame.core.beancopy.ConversionException;
import com.huatek.frame.core.beancopy.ConvertParam;

/**
 * {@link com.huatek.frame.core.beancopy.Converter} implementaion that handles conversion
 * to and from <b>Boolean</b> objects.
 * {@link com.huatek.frame.core.beancopy.Converter} implementaion that
...
public final class BooleanConverter extends AbstractConverter {
    ...
    /**
     * Create a {@link com.huatek.frame.core.beancopy.Converter} that will throw a {@link ConversionException}
    ...
    /**
     * Create a {@link com.huatek.frame.core.beancopy.Converter} that will return the specified default value
     * if a conversion error occurs, ie the string value being converted is
     * not one of the known true strings, nor one of the known false strings.
     *
    ...
    /**
     * Create a {@link com.huatek.frame.core.beancopy.Converter} that will return
     ...
     * The set of strings that are known to map to Boolean.TRUE.
     */
    private String trueString = ConvertParam.trueValue.value;

    /**
     * The set of strings that are known to map to Boolean.FALSE.
     */
    private String falseString =ConvertParam.falseValue.value;
	...
	protected String convertToString(Object value) throws Throwable {
        return Boolean.valueOf(value.toString())?trueString:falseString;
    }
    /**
