...
public abstract class NumberConverter extends AbstractConverter {
    ...
    public boolean getUseLocaleFormat() {
    ...
    protected Object convertToType(Class targetType, Object value) throws Throwable {
        ...
        if (value instanceof Boolean) {
            return toNumber(sourceType, targetType, ((Boolean)value).booleanValue() ? Integer.valueOf(trueString) : Integer.valueOf(falseString));
        }
