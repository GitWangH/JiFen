        ...
        .run([
            ...
            function($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "   <thead ng-mouseenter=\"parentEdit()\" ng-mouseleave=\"parentMove()\">\n" +
                    "     <tr>\n" +
                    ...
                    "       ng-class=\"'level-' + {{ row.level }} + (row.branch.selected ? ' active':'')\" ng-class=\"{'showItem':showtimes}\"  class=\"tree-grid-row\">\n" +
                    ...
                    "         <div ng-if=\"!col.cellTemplate && !row.branch['editing']\">{{row.branch[col.field]}}</div>\n" +
                    "         <div ng-if=\"!col.cellTemplate && row.branch['editing']\"><input ng-model=\"row.branch[col.field]\"/></div>\n" +
                    "       </td>\n" +
                    "     </tr>\n" +
                    "   </tbody>\n" +
                    " </table>\n" +
                ...
                return {
                    ...
                    link: function(scope, element, attrs) {
                        ...
                        scope.sortBy = function(col) {
						 ...
						 scope.parentEdit=function(){
						 	console.log("1")
						 };
						  scope.parentMove=function(){
						 	alert("2")
						 }
