...
nyaBsSelect.directive('nyaBsSelect', ['$parse', '$document', '$timeout', '$compile', 'nyaBsConfig', function ($parse, $document, $timeout, $compile, nyaBsConfig) {
  ...
  var NO_SEARCH_RESULT = '<li class="no-search-result"><span></span></li>';

  var ACTIONS_BOX = '<div class="bs-actionsbox">' +
    '<div class="btn-group btn-group-sm btn-block">' +
    '<button class="actions-btn bs-select-all btn btn-default">全选</button>' +
    '<button class="actions-btn bs-deselect-all btn btn-default">全不选</button>' +
    '</div>' +
    '</div>';
