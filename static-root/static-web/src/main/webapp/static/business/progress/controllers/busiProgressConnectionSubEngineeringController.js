 ...
 * 形象清单与分部分项挂接 -  显示分部分项
 */
angular.module('huatek.controllers').controller('busiProgressConnectionSubEngineeringController', function($scope, $location, $http, $rootScope, editService, listService, shareData, httpService, treeGridService) {
    ...
    /**queryAction*/
    /*查询顶级节点URL*/
    var queryTopLevelUrl = '/api/tendersBranch/queryTopLevel';
    /*根据父级节点查询子级节点URL*/
    var queryChildNodesUrl = '/api/tendersBranch/queryChildNodes/';
    /**saveAction*/
    var saveUrl = "/api/busiProgressImageToBranchConnect/save";

    /**创建表格 工程量清单 树形列表 - 不可编辑*/
    var columnsArr = [];
    columnsArr.push(new treeColumn('编号', 'tendersBranchCode', '50%'));
    columnsArr.push(new treeColumn('名称', 'tendersBranchName', '50%'));
