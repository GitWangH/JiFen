 ...
 * 标段分部分项 挂接合同清单
 */
angular.module('huatek.controllers').controller('ChangeManageAddContractDetailController', function($scope, $location, $http, listService, treeGridService, httpService) {
