/**
 * 二衬厚度检测Controller 
 * BusiQualitySecondLiningThicknessCheckController
 */
'use strict';
angular.module('huatek.controllers').controller('BusiQualitySecondLiningThicknessCheckController', function ($rootScope, $scope, $location, $http, listService) {
	...
	$scope.tableGrid = {
	        ...
	        columnDefs: [
				...
				{ name: '设计厚度(cm)', field: 'designThickness',width: '8%', enableColumnMenu: false},
				{ name: '实测平均厚度(cm)', field: 'actualMeasureAverageThickness',width: '8%', enableColumnMenu: false},
				{ name: '单线合格率(%)', field: 'oneLineQualifiedRate',width: '8%', enableColumnMenu: false},
				{ name: '3线合格率(%)', field: 'threeLineQualifiedRate',width: '8%', enableColumnMenu: false},
				{ name: '5线合格率(%)', field: 'fiveLineQualifiedRate',width: '8%', enableColumnMenu: false},
				{ name: '检测人员', field: 'checkUserName',width: '8%', enableColumnMenu: false},
				...
				{ name: '修改日志', field: 'modifyTime',width: '15%', enableColumnMenu: false,cellTemplate:listService.getLinkCellTmplate('queryModifyLog','modifyTime','日志')}
	        ]
	    };
		/**
	    ...
	    // 定义功能按钮
		var btnArray = [];
	    btnArray.push(new pageButton('新增','add','/secondLiningThicknessCheck/add','addData'));
	    btnArray.push(new pageButton('修改','edit','/secondLiningThicknessCheck/edit','editData'));
	    /*btnArray.push(new pageButton('查看', 'view', '/secondLiningThicknessCheck/view', 'viewData'));*/
		/**
		 * 设置界面的功能按钮.
		 */
	    ...
	    $scope.execute = function(operation, param){
	        ...
	        if(operation == 'addData'){
	        	if(isAdminFn()){
	        		listService.addData($scope, new popup("新增","/secondLiningThicknessCheck/add", null, "1200", "800"));
	        	}
	        }else if(operation == 'editData'){
	        	if(isAdminFn()){
	        		listService.editData($scope, $scope.gridApi, new popup("修改","/secondLiningThicknessCheck/edit", null, "1200", "800"));
	        	}
	        }else if(operation == 'viewData'){
	        	listService.editData($scope, $scope.gridApi, new popup("查看","/secondLiningThicknessCheck/view", null, "1200", "800"),param);
	        	...
	        	var logShowFieldArr = [
   	        	...
   	        	var queryLogUrl = '/api/secondLiningThicknessCheck/queryModifyLog/'+param.id;
	    ...
	    var load = $scope.load = function() {
	        listService.loadData($scope, '/api/secondLiningThicknessCheck/query', $scope.tableGrid);
	    }
...
angular.module('huatek.controllers').controller('BusiQualitySecondLiningThicknessCheckAddController', function ($scope, $http, editService, httpService,$rootScope,listService) {
	var addDataUrl = 'api/secondLiningThicknessCheck/add';
	var editDataUrl = 'api/secondLiningThicknessCheck/edit';
	var homeUrl = '/secondLiningThicknessCheck/home';
    ...
    formFieldArray.push(new FormElement(1,'实测平均厚度(cm)','actualMeasureAverageThickness','number',0,'30'));
    formFieldArray.push(new FormElement(1,'单线合格率(%)','oneLineQualifiedRate','number',0,'30'));
    formFieldArray.push(new FormElement(1,'3线合格率(%)','threeLineQualifiedRate','number',0,'30'));
    formFieldArray.push(new FormElement(1,'5线合格率(%)','fiveLineQualifiedRate','number',0,'30'));
    ...
    contractFileUUID.systemHeader = "/root/quality/thirdPartyInspection/liningThickness";
...
/*查看明细*/
angular.module('huatek.controllers').controller('BusiQualitySecondLiningThicknessCheckDetailController', function ($scope, $http, editService, httpService,$rootScope) {
	var editDataUrl = 'api/secondLiningThicknessCheck/edit';
	var homeUrl = '/secondLiningThicknessCheck/home';
    ...
    formFieldArray.push(new FormElement(1,'实测平均厚度(cm)','actualMeasureAverageThickness','number',0,'30',null,null,null,null,null,'readonly'));
    formFieldArray.push(new FormElement(1,'单线合格率(%)','oneLineQualifiedRate','number',0,'30',null,null,null,null,null,'readonly'));
    formFieldArray.push(new FormElement(1,'3线合格率(%)','threeLineQualifiedRate','number',0,'30',null,null,null,null,null,'readonly'));
    formFieldArray.push(new FormElement(1,'5线合格率(%)','fiveLineQualifiedRate','number',0,'30',null,null,null,null,null,'readonly'));
