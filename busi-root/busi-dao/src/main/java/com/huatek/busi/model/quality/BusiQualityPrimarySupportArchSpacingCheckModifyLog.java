...
import com.huatek.frame.core.model.BaseEntity;
  ...
  * @author: rocky_wei
  * @Email : 
  * @date: 2017-11-24 16:32:12
  * @version: Windows 7
  */

@Entity
@Table(name = "busi_quality_primary_support_arch_spacing_check_modify_log")
public class BusiQualityPrimarySupportArchSpacingCheckModifyLog extends BaseEntity {
    ...
    @Column(name= "ARCH_SPACING_CHECK_MODIFY_LOG_ID", nullable = true )
 	private Long id;
 
	/** @Fields primarySupportClearanceSectionCheck : 初期支护拱架间距检测 */
	@ManyToOne(cascade = { CascadeType.REFRESH, CascadeType.MERGE }, optional = true)
	@JoinColumn(name = "ARCH_SPACING_CHECK_ID")
	private BusiQualityPrimarySupportArchSpacingCheck primarySupportClearanceSectionCheck;
    ...
    public void setActualMeasureRoofTrussesQuantity(BigDecimal actualMeasureRoofTrussesQuantity){
    ...
    public void setDesignMeasureRoofTrussesQuantity(BigDecimal designMeasureRoofTrussesQuantity){
	...
	public BusiQualityPrimarySupportArchSpacingCheck getPrimarySupportClearanceSectionCheck() {
		return primarySupportClearanceSectionCheck;
	}

	public void setPrimarySupportClearanceSectionCheck(
			BusiQualityPrimarySupportArchSpacingCheck primarySupportClearanceSectionCheck) {
		this.primarySupportClearanceSectionCheck = primarySupportClearanceSectionCheck;
	}
