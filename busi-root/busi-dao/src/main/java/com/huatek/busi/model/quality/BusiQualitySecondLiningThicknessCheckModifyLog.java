...
@Entity
@Table(name = "busi_quality_second_lining_thickness_check_modify_log")
public class BusiQualitySecondLiningThicknessCheckModifyLog extends BaseEntity {
    ...
    @Column(name= "SECOND_THICKNESS_CHECK_MODIFY_LOG_ID", nullable = true )
 	private Long id;
 
    
	/** @Fields secondLiningThicknessCheck : 二衬厚度检测 */
	@ManyToOne(cascade = { CascadeType.REFRESH, CascadeType.MERGE }, optional = true)
	@JoinColumn(name = "SECOND_LINING_THICKNESS_CHECK_ID")
    private BusiQualitySecondLiningThicknessCheck secondLiningThicknessCheck;
    ...
    public BusiQualitySecondLiningThicknessCheck getSecondLiningThicknessCheck() {
		return secondLiningThicknessCheck;
	}

	public void setSecondLiningThicknessCheck(
			BusiQualitySecondLiningThicknessCheck secondLiningThicknessCheck) {
		this.secondLiningThicknessCheck = secondLiningThicknessCheck;
	}
    ...
    public void setActualMeasureAverageThickness(BigDecimal actualMeasureAverageThickness){
