 ...
 * @author: jordan_li
 * @Email :
 * @date: 2017-11-25 15:37:25
 * @version: Windows 7
 */

@Entity
@Table(name = "busi_quality_primary_support_clearance_section_check_modify_log")
public class BusiQualityPrimarySupportClearanceSectionCheckModifyLog extends
		BaseEntity {
	...
	@Column(name = "CLEARANCE_SECTION_CHECK_MODIFY_LOG_ID", nullable = true)
	private Long id;

	/** @Fields PrimarySupportClearanceSectionCheck : 初期支护净空断面检测 */
	@ManyToOne(cascade = { CascadeType.REFRESH, CascadeType.MERGE }, optional = true)
	@JoinColumn(name = "CLEARANCE_SECTION_CHECK_ID")
	private BusiQualityPrimarySupportClearanceSectionCheck busiQualityPrimarySupportClearanceSectionCheck;
	...
	public BusiQualityPrimarySupportClearanceSectionCheck getBusiQualityPrimarySupportClearanceSectionCheck() {
		return busiQualityPrimarySupportClearanceSectionCheck;
	}

	public void setBusiQualityPrimarySupportClearanceSectionCheck(
			BusiQualityPrimarySupportClearanceSectionCheck primarySupportClearanceSectionCheck) {
		busiQualityPrimarySupportClearanceSectionCheck = primarySupportClearanceSectionCheck;
	}
