 ...
 * 铺摊机实体类.
 * 
 * @ClassName: BusiQualitySpreaderInspection
 * @Description:铺摊机实体类
 * @author: jordan_li
 * @Email :
...
@Entity
@Table(name = "busi_quality_spreader_inspection")
public class BusiQualitySpreaderInspection extends BaseEntity {
	...
	@Column(name = "SPREADER_INSPECTION_ID", nullable = true)
	private Long id;
	...
	/** @Fields pavingTemperature : 摊铺温度 */
	@Column(name = "PAVING_TEMPERATURE", nullable = true, length = 20)
	private String pavingTemperature;

	/** @Fields pavingSpeed : 摊铺速度 */
	@Column(name = "PAVING_SPEED", nullable = true, length = 20)
	private String pavingSpeed;

	/** @Fields pavingThickness : 摊铺厚度 */
	@Column(name = "PAVING_THICKNESS", nullable = true, length = 20)
	private String pavingThickness;
