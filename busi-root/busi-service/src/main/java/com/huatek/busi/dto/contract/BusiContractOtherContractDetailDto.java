 ...
 * 代码自动生成model类.
 * 
 * @ClassName: BusiContractOtherContractDetailDto
 * @Description: 其它合同明细管理Dto
 * @author: mickey_meng
 * @Email : mickey_meng@huatek.com
 * @date: 2017-10-31 17:09:20
 * @version: 1.0
 */
public class BusiContractOtherContractDetailDto {
	...
	/** @Fields contractDetailParentId : 父级ID */
	private String ParentId;

	/** @Fields detailMoney : 金额（元） */
	private String detailMoney;

	/** @Fields orderNumber : 排序编号 */
	...
	// private BusiContractOtherContractDto busiContractOtherContractDto;
