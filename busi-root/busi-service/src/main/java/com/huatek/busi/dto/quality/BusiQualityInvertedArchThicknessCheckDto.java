...
public class BusiQualityInvertedArchThicknessCheckDto {
	private Long id;
	...
	private String meterPointStakeNo;// 测点桩号

	private String liningType;// 衬砌类型

	private String designThickness;// 设计厚度(cm)

	private String actualMeasureThickness;// 实测厚度(cm)
	...
	public String getActualMeasureThickness() {
		return actualMeasureThickness;
	}

	public void setActualMeasureThickness(String actualMeasureThickness) {
