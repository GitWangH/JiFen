...
public class BusiQualityPrimarySupportArchSpacingCheckDto {
	private Long id;
	...
	private String designIntervalLength;// 设计间距(cm)

	private String actualMeasureAverageSpacing;// 实测平均间距(cm)

	private String actualMeasureRoofTrussesQuantity;// 实测榀数

	private String designMeasureRoofTrussesQuantity;// 设计榀数
